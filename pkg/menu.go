...
// ChangeDictionaryDef allows you to change definition for frazes autogenerated
// by menu.
// For example if you want to change "0) Exit" menu line to "0) Close menu" run
// (*Menu).ChangeDictionaryDef(DictionaryKeyExit, "Close menu")
func (m *Menu) ChangeDictionaryDef(key DictionaryKey, value string) *Menu {
